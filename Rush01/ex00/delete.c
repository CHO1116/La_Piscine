...
/*   Updated: 2022/01/16 18:57:48 by eukwon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rush01.h"

void	del_fix(int (*return_map)[4], int target_number, int input_index)
{
	del_fix_c_d(return_map, target_number, input_index);
	del_fix_c_u(return_map, target_number, input_index);
	del_fix_r_f(return_map, target_number, input_index);
	del_fix_r_b(return_map, target_number, input_index);
}
